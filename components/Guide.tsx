      ...
      <div className="border-2 border-red-500 padding-container max-container w-full pb-24">
        ...
        <div className="flex flex-wrap justify-between gap-5">
          ...
          <p className="regular-16 text-gray-30 xl:max-w-[520px]">
            Only with hiZen application, you will no longer get lost and get
            lost again, because we already suppot offline maps when there is no
            internet connection in the field. Invite your friends and relatives
            to have fun in the wilderness through the vally and reach the top of
            the mountain.
          </p>
        </div>
      </div>
